...
**Failed Logic**
> The DE27IM matrices of *Shelters* and it's complementary relationship
> *Sheltered* are not transposed versions of each other because the DE27IM
> testing checks the *convex hull* of **A** against the standard volume of
> **B**, not the *convex hull* of **B**.

> Likewise the DE27IM matrices of *Surrounds* and *Enclosed* are not transposed
> versions of each other  because the testing checks the *exterior boundary* of
> **A** against the standard volume of **B**, not the *exterior boundary* of
> **B**.

- Tests for Sheltered and Enclosed relationships should be explicitly defined
and included in the decision tree rather than being generated by inverting
matrices for the *Shelters* and *Surrounds* relationships.
## Data Prep Changes
1. Relation tests for External and Hull should be external vs external and hull vs hull.
2. Create External and Hull polygons during the initial data prep stage.
3. Determine if External and Hull tests need to include boundary relations
4. Establish exactly what relation data is required for boundary slices.
## TO Do Next
